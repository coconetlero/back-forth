...
def test_bifurcation_finding_2():
    ...
    # scc_tree_o =    [1, 0, -.25, 0, 1, 0, -.75, 0, -.25, 0, 1, 0, -.5, 0, 1, 0, -.25, 0, -.75, 0, 1, 0, -.25, 0]
    # scc_tree =      [2, 1, 0, 0, 3, -.25, 0, 4, 1, 0, 3, -.75, 0, 5, -.25, 0, 6, 1, 0, 5, -.5, 0, 7, 1, 0, 5, -.25, 0, 3, -.75, 0, 8, 1, 0, 3, -.25, 0]
    ...
    bifurcations = SCC_Tree.create_extended_tree_2(scc_tree_o)
    print(bifurcations)
    # ext_tree.insert(2, 0)
