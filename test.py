...
def test_bifurcation_finding_2():
    ...
    # scc_tree_o =  [1, 0, 0, 0, -.75, 1, -.75, 1, -.75, 1, -.75, 1, -.75, 1, -.75, 1, -.75, 1, -.75, 0, 0, 0]    
    # scc_tree =  [2, 1, 0, 0, 0, 0, 3, -.75, 4, 1, 3, -.75, 5, 1, 3, -.75, 6, 1, 3, -.75, 7, 1, 3, -.75, 8, 1, 3, -.75, 9, 1, 3, -.75, 10, 1, 3, -.75, 0, 0]    
    
    # scc_tree_o =    [1, 0, 0, 0, 0, 0, -.25, 0, 0, 1, 0, 0, -.5, 0, 1, 0, -.25, 0, -.75, 0, 0, 1, 0, 0, -.5, 0, 1, 0, -.75, 0, -.25, 0, 1, 0, -.75, 0]    
    # # scc_tree_o =    [1, 0, 0, 0, 0, 0, 1, 0, -.75, 0, 0, 1, 0, 0, -.5, 0, 1, 0, -.75, 0, -.25, 0, 1, 0, -.75, 0]
    # scc_tree =      [2, 1, 0, 0, 3, 0, 0, 4, -.25, 0, 5, 1, 0, 4, -.5, 0, 6, 1, 0, 4, -.25, 0, 3, -.75, 0, 7, 1, 0, 3, -.5, 0, 8, 1, 0, 3, -.75, 9, -.25, 0, 10, 1, 0, 9, -.75, 0]

    # scc_tree_o =    [1, 0, -.25, 0, -.25, 0, 1, 0, -.5, 0, 1, 0, -.25, 0, -.75, 0, 1, 0, -.75, 0, 1, 0, -.25, 0]
    # scc_tree =      [2, 1, 0, 0, 3, -.25, 0, 4, -.25, 0, 5, 1, 0, 4, -.5, 0, 6, 1, 0, 4, -.25, 0, 3, -.75, 0, 7, 1, 0, 3, -.75, 0, 8, 1, 0, 3, -.25, 0]

    # scc_tree_o =    [1, 0, -.25, 0, 1, 0, -.75, 0, -.25, 0, 1, 0, -.75, 0, 1, 0, -.75, 0, 1, 0, -.25, 0, -.75, 0, 1, 0, -.25, 0]
    # scc_tree =      [2, 1, 0, 0, 3, -.25, 0, 4, 1, 0, 3, -.75, 0, 5, -.25, 0, 6, 1, 0, 5, -.75, 0, 7, 1, 0, 5, -.75, 0, 8, 1, 0, 5, -.25, 0, 3, -.75, 0, 9, 1, 0, 3, -.25, 0]

    scc_tree_o =    [1, 0, -.25, 0, 1, 0, -.75, 0, 1, 0, -.75, 0, -.25, 0, 1, 0, -.5, 0, 1, 0, -.25, 0, -.25, 0]
    scc_tree =      [2, 1, 0, 0, 3, -.25, 0, 4, 1, 0, 3, -.75, 0, 5, 1, 0, 3, -.75, 0, 6, -.25, 0, 7, 1, 0, 6, -.5, 0, 8, 1, 0, 6, -.25, 0, 3, -.25, 0]


    [X, Y] = SCC_Tree.plot_tree(scc_tree)
    imscc.display_tree(scc_tree_o, [])
